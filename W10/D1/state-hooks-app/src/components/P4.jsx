...
//Derived state and conditinal rendering
//Derived state is a value calculated from existing state
//It is not usaually stored seperatally in state
//Insted,we compute it during rendering
export function DerivedStateCondRender(){
    ...
    if(totalTasks === 0){
        statusMessage='No tasks avaliable';
    }
